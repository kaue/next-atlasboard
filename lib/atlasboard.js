                    ...
                    files.forEach(function(file) {
                        ...
                        if (path.extname(file) == ".json") {
                            try {
                                ...
                                var job = function(){}
                                if (fs.existsSync(path.join(pathHere, path.basename(directory) + ".js"))) {
                                    job = require(path.join(pathHere, path.basename(directory) + ".js"))
                                } else if (fs.existsSync(path.join(pathHere, "index.js"))) {
                                    job = require(path.join(pathHere, "index.js"));
                                } else {
                                    console.error("Could not find job file in %s", pathHere);
