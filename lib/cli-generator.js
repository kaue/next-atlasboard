...
if (argument == "generate") {
    ...
    var newItemLocation = path.join(process.cwd(), value + "s", name);
    console.log("Creating new %s at %s...", value, newItemLocation);
    ...
    fs.readdir(path.join(__dirname, "..", "samples", value), function(err, files) {
        ...
        files.forEach(function (file) {
            var targetFileName = path.join(process.cwd(), value + "s", name, name + path.extname(file));
        ...
        console.log("New %s created successfully", value);
