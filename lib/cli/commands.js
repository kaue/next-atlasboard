...
// ----------------------------------
  ...
  return logicCli.start(first); //first parameters can be the port number
}
else{
  // ----------------------------------
  // No command found.
  ...
  var commands = [
    ...
    {command: "list", description: "List all available components (widgets or jobs) within all available packages."},
