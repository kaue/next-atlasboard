...
module.exports = function(app, packagesPath) {
    ...
    app.get("/:dashboard/styles.css", function(req, res) {
      ...
      web_logic.render_css_assets(packagesPath, safeDash, req, res);
    });
    ...
    app.get("/:dashboard", function(req, res) {
      var safeDash = path.basename(req.params.dashboard).split('.')[0];
      web_logic.render_dashboard(packagesPath, safeDash, req, res);
    });
    ...
    app.get("/:dashboard/scripts.js", function(req, res) {
      var safeDash = path.basename(req.params.dashboard).split('.')[0];
      web_logic.render_script_assets(atlasboard_assets_folder, wallboard_assets_folder, packagesPath, safeDash, req, res);
    });
    ...
    app.get("/widgets/:widget", function(req, res) {
        ...
        web_logic.render_html_widget(packagesPath, safeWidget, req, res);
    });
