...
module.exports = {
    ...
    render_dashboard : function (packagesPath, dashboard_name, req, res){
        ...
        item_manager.get_first(packagesPath, dashboard_name, "dashboards", ".json", function(err, dashboard){
            ...
            if (dashboard){
                ...
                res.send(404, "Trying to render dashboard " + dashboard_name + ", but couldn't find any dashboard in the packages folder");
            }
        });
    },
    ...
    // Render CSS
    // ---------------------------------------------------------------
    // This is REALLY slow, must me at least be cached.
